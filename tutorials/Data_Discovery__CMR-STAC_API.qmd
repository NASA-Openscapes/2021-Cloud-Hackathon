...
- Perform post search filting of CMR-STAC API search result
- Extract and save data access URLs for geospatial assets
...
TODO: add background about id, title, describe,... pystac/pystac-client objects
...
### Extract the coordinates for the region of interest
...
STAC Collection is synonomous with what we usually consider a data product. Desired STAC Collections are submitted to the search API as a list containing the collection `id`.
