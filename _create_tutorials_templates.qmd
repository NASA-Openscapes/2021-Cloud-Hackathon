...
for (f in ipynb_files) {  ## f = ipynb_files[3]
  ...
  read_file(glue("tutorials-templates/{f}.qmd")) %>%
    ...
    # TODO: revisit changing the image filepaths with the new assets/images
    # str_replace_all("data/(.*).png", "../tutorials/data/\\1.png" ) %>%
    # str_replace_all("img/(.*).png", "../tutorials/img/\\1.png" ) %>%
